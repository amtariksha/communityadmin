...
class AppTheme {
  // -------------------------------------------------------------------------
  // Brand palette — white-label, build-time
  //
  // Resolved through `BrandConfig`, generated by `tool/apply_brand.dart`
  // from `branding/<slug>/brand.json`. Public names are unchanged so
  // every `AppTheme.*` callsite — including `const` widgets — keeps
  // compiling. Re-skin via a brand.json + the applicator, not here.
  // -------------------------------------------------------------------------

  /// Primary brand colour — wordmark, Send-OTP button, Home header band,
  /// Total Due amount, bottom-nav active label.
  static const Color primaryColor = BrandConfig.primaryColor;

  /// Slightly cooler primary used on the segmented switcher selected pill.
  static const Color primaryColorVariant = BrandConfig.primaryColorVariant;

  /// Soft cream/peach tint used as a background for promo / CTA
  /// surfaces (e.g. Total Due hero card on HomeScreen).
  static const Color primarySoftTint = BrandConfig.primarySoftTint;

  /// Brand surface accent — multi-option segmented switcher container
  /// background.
  static const Color brandSurfaceAccent = BrandConfig.brandSurfaceAccent;

  /// Warm-brown muted text used on the unselected segmented-switcher
  /// label.
  static const Color brandMutedText = BrandConfig.brandMutedText;

  /// Secondary accent — kept for legacy callers (login gradient etc.).
  static const Color secondaryColor = BrandConfig.secondaryColor;
